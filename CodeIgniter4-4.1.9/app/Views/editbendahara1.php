...
<div class="container mt-3">
  <h2>tampil bendahara</h2>
  <form action="<?= base_url('home/simpan_bendahara') ?>" method="post">
    <div class="mk-3">
      <label for="nama_siswa ">nama bendahara :</label>
      <input type="text" class="form-control" id="nama_bendahara" placeholder="Enter nama_bendahara" name="nama_bendahara" value="<?=$bendahara1->nama_bendahara?>">
    </div>
    <div class="mk-3">
    ...
    <tr>
      <input type="hidden" value="<?=$bendahara1->id_bendahara?>" name="id">
