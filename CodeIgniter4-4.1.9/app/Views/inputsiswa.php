...
<h2 style="font-family: sans-serif; background-color:  #f0f0f0;font-weight: bold;">siswa</h2>
  ...
  <form action="/home/input_siswa" method="POST">
    <table>
      <tr>
        <td>nama siswa</td>
        <td><input type="text" class="form-control" name="nama_siswa" value="<?= $siswa1->nama_siswa?>"></td>
      </tr>
      <tr>
        <td>jenis kelamin</td>
        <td>
      ...
      <tr>
        <td>nomor telepon</td>
        <td><input type="text" class="form-control" name="nomor_telepon" value="<?= $siswa1->nomor_telepon?>"></td>
      </tr>
      <tr>
        <td>email</td>
